...
import { CommentInput } from "../post/[id]/_components/comment-input";
import { ReplyContextProvider } from "../post/[id]/_components/reply-context";
import { Comments } from "../post/[id]/_components/comments";
    ...
    <div className="flex h-full min-w-full flex-col overflow-y-auto">
      <ReplyContextProvider>
        ...
        <div className="mb-6 mt-auto space-y-4">
          <CommentInput postId="id-page-one" />
